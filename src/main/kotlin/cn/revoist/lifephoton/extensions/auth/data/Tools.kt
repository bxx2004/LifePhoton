package cn.revoist.lifephoton.extensions.auth.data

import cn.revoist.lifephoton.extensions.auth.Auth
import cn.revoist.lifephoton.extensions.auth.data.entity.UserDataEntity
import cn.revoist.lifephoton.extensions.auth.data.table.UserDataTable
...
object Tools {
    ...
    fun updateToken(username: String):Pair<String, String> {
        ...
        Tools.expired[accessToken] = System.currentTimeMillis() + (30 * 60 * 1000)
